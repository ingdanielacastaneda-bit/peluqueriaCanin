...
public class ModificarDatos extends javax.swing.JPanel {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            mostrarMensaje("Error al modificar los datos: " + ex.getMessage(), "Error", "Error");
        }
    ...
    private void CargarDatos(int num_cliente) {
        ...
        txtNombre.setText(masco.getNombre() != null ? masco.getNombre() : "");
        txtColor.setText(masco.getColor() != null ? masco.getColor() : "");
        txtRaza.setText(masco.getRaza() != null ? masco.getRaza() : "");
        txtObservaciones.setText(masco.getObservaciones() != null ? masco.getObservaciones() : "");
        
        if (masco.getUnDuenio() != null) {
            txtDireccion.setText(masco.getUnDuenio().getDireccion() != null ? masco.getUnDuenio().getDireccion() : "");
            txtNombreDueño.setText(masco.getUnDuenio().getNombre() != null ? masco.getUnDuenio().getNombre() : "");
            txtCelDueño.setText(masco.getUnDuenio().getCelDuenio() != null ? masco.getUnDuenio().getCelDuenio() : "");
        }
        
        seleccionarComboBox(cmbAtencionEspecial, masco.getAtencion_especial());
        seleccionarComboBox(cmbAlergico, masco.getAlergico());
    }
    
    private void seleccionarComboBox(javax.swing.JComboBox<String> comboBox, String valor) {
        if (valor == null) {
